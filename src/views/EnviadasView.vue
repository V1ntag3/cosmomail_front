        ...
        <table class="table table-hover table-striped">
            <tbody>
                <div class="container-nenhuma-mensagem" v-if="mensagens.length == 0">
                    <img class="imagem-nenhuma-mensagem" src="../assets/img/nenhuma_mensagem_encontrada.png" alt=""
                        srcset="">
                ...
                <div v-for="(men, index) in mensagens" :key="index" class="card-mensagem">
                    ...
                    <div @click="this.$router.push('/mensagem/' + men.id)"
                        class="col-12 col-sm-5 col-md-4 col-lg-4 col-xl-4 item-card"><span class="title-item">Para:</span>
                        {{ men.nome_destinatario }}</div>
                    <div @click="this.$router.push('/mensagem/' + men.id)"
                        class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 item-card"><span
                            class="title-item">Assunto:</span> {{ men.assunto }}</div>
                    <div @click="this.$router.push('/mensagem/' + men.id)"
